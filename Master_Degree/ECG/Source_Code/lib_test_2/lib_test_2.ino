...
void setup() {
  ...
  DebugSerial.print("Recv 1 End, Send 2 Start : ");
  DebugSerial.println(millis());

  if (BG96.socketSend(sendBuffer2) == 0)
    DebugSerial.println("Socket Send!!!");

  DebugSerial.print("Send 2 End, Recv 2 Start : ");
  DebugSerial.println(millis());
